...
class AddWithdrawsSeamlessFree extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('withdraws_seamless_free')) {
            Schema::create('withdraws_seamless_free', function (Blueprint $table) {
