...
class CreateUsersChubaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('users_chuba')) {
        Schema::create('users_chuba', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('users_chuba');
    }
}
