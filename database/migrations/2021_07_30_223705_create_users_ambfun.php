...
class CreateUsersAmbfun extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('users_ambfun')) {
            Schema::create('users_ambfun', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('users_ambfun');
    }
}
