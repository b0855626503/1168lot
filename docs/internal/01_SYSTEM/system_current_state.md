...
- ปุ่ม `เปิดรับ` ถูกถอดออกจากคอลัมน์ `ดำเนินการ` และย้ายพฤติกรรมสลับสถานะไปที่ช่อง `สถานะ` แทน
- ช่อง `สถานะ` ของงวด `open/closed` สามารถคลิกเพื่อสลับ `เปิดรับ <-> ปิดรับ` ได้เมื่อผู้ใช้มีสิทธิ์ที่เกี่ยวข้อง (`lotto_draws.open`/`lotto_draws.close`) และต้องยืนยันผ่าน popup ก่อนทุกครั้ง
- ตาราง `lotto/draws` แสดงสีพื้นหลังโทนอ่อนแยกตามสถานะงวด:
  - `draft` = เทาอ่อน
  - `open` = เขียวอ่อน
  - `closed` = เหลืองอ่อน
  - `resulted` = ฟ้าอ่อน
