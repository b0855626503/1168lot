# AI Coding Agent Guide For Gametech Platform (Archived)

## Quick Links
- Dev workflow (PHPStorm + WSL): `docs/internal/01_SYSTEM/dev-workflow-phpstorm-wsl.md`
- Lotto implementation handover: `docs/internal/01_SYSTEM/lotto-system-handover-th.md`
- FrontendApi agent playbook: `docs/public/integration/agent-frontendapi.md`
- Lotto system roadmap plan: `docs/04_PLANS/2026-03-20_lotto-system-roadmap.md`
- Lotto execution phases plan: `docs/04_PLANS/2026-03-21_lotto-execution-phases.md`
- Lotto Concord/Proxy cleanup plan: `docs/04_PLANS/2026-03-21_lotto-concord-proxy-cleanup.md`
- Admin team menu active plan: `docs/04_PLANS/2026-03-21_admin-team-menu-active.md`
- Immediate query dedup + page speed plan: `docs/04_PLANS/2026-03-21_immediate-query-dedup-page-speed.md`
