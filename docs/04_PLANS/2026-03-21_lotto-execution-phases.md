> สถานะ: PENDING
> วันที่: 2026-03-21
> โดเมน/เรื่อง: Lotto / Execution Phases
...
แผนนี้แตกต่อจาก `docs/04_PLANS/2026-03-20_lotto-system-roadmap.md` เพื่อใช้ขับงานแบบเป็น phase โดยยึดสถานะจริงของโมดูล `packages/Gametech/Lotto` ณ วันที่ 2026-03-20 และเน้นลำดับแบบ `admin-first` เพื่อให้ทีมส่งงานทีละส่วนได้โดยไม่กระทบ flow แทงและตัดสินผลเร็วเกินไป
...
4. อัปเดต `docs/internal/05_ARCHIVE/rules/agents.md` และไฟล์แผนให้สะท้อน pattern ล่าสุดของ Lotto admin.
