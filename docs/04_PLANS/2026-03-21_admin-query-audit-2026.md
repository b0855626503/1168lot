> สถานะ: DONE
> วันที่: 2026-03-21
> โดเมน/เรื่อง: Admin / Query Audit
> แทนแผนเก่า: -
...
6. บันทึกเอกสารสรุปผลการตรวจสอบและรายการ patch ที่ดำเนินการลงในโปรเจค (`docs/internal/05_ARCHIVE/decisions/admin-query-audit-2026.md`) โดยแยกตาม route และเขียนเป็นภาษาไทย พร้อมระบุรายละเอียด table/index ที่ปรับ
...
## Output
- เอกสารสรุปผล: `docs/internal/05_ARCHIVE/decisions/admin-query-audit-2026.md`
