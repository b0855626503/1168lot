...
## ACTIVE
- `2026-05-11_member-market-policy-blacklist-audit.md` (`Member lotto market policies whitelist→blacklist — PR-01 audit`)
...
## SUPERSEDED
- `2026-03-20_lotto-system-roadmap.md` → ถูกแทนโดย `2026-03-21_lotto-execution-phases.md`
- `2026-03-27_lotto-pr-step-by-step.md` → ถูกแทนโดย `2026-03-27_lotto-global-config-migration.md`
