...
- เมื่อผู้ใช้พิมพ์ว่า `คู่มือ` ให้หมายถึง `docs/public/api/api-frontend-v1.md`
- เมื่อผู้ใช้พิมพ์ว่า `คู่มือ agent` หรือ `คู่มือเอเจ้น` ให้หมายถึงเอกสารสำหรับ Agent ทำงาน เช่น `docs/internal/05_ARCHIVE/rules/agents.md` และ `docs/public/integration/agent-frontendapi.md`
...
5. อัปเดตเอกสาร `docs/public/api/api-frontend-v1.md` ทุกครั้งที่เพิ่ม/เปลี่ยน contract
...
- Docs หลัก API: `docs/public/api/api-frontend-v1.md`
