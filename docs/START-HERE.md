...
1. ไฟล์นี้ — เสร็จแล้ว
2. `boat_ask(question="system overview + architecture map")` — quick codebase intelligence
...
- งาน MCP / code intelligence: เพิ่ม `docs/internal/01_SYSTEM/mcp-operating-guide.md`
