                ...
                <div class="wr-shell">
                    ...
                    <div class="wr-card p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 mb-2">
                                <div class="wr-filter-block">
                                    <div class="wr-filter-label">Username สมาชิก</div>
                                    <input v-model.trim="detailFilters.user_id" type="text" class="form-control form-control-sm" placeholder="เช่น boat001" @keyup.enter.prevent="loadDetails">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 mb-2">
                                <div class="wr-filter-block">
