<nav class="x-header js-header-selector navbar navbar-expand-lg -anon">
    <div class="container-fluid -inner-container">
        ...
        <div id="headerBrand">
            <a class="navbar-brand" href="{{ route('customer.session.login_new',[ 'id' => $id ]) }}">
...
{{--                </a>--}}
                ...
                <a href="{{ route('customer.contributor.register',[ 'id' => $id ]) }}" class="-btn-header-login btn mr-1 mr-sm-2">
