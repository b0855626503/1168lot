...
@if(request()->routeIs('customer.session.*') || request()->routeIs('customer.promotion.show'))
                        ...
                        <div class="-inner-top-body-section">
                            ...
                            <div class="col-6 -wrapper-box">
                                <a
                                        ...
                                        href="{{ route('customer.contributor.register',[ 'id' => $id ]) }}"
                                            ...
                                            <div class="-promotion-box-wrapper">
                                                <button type="button"
                                                    ...
                                                    <picture>
                                                        ...
                                                        <source type="image/png"
                                                                srcset="https://asset.cloudigame.co/build/admin/img/wt_theme/ezl/ic-gift.png"/>
                                                        <img class="-img" alt="BONUS" width="26" height="26"
                                                             loading="lazy"
                                                             fetchpriority="low"
                                                             src="https://asset.cloudigame.co/build/admin/img/wt_theme/ezl/ic-gift.png"/>
                                                    </picture>

                                                    <span class="-title">{{ __('app.home.bonus') }}</span>
                        ...
                        <div data-animatable="fadeInModal" class="order-lg-2 -form order-0 animated fadeInModal">
                            <div class="container">
                                <div class="el-input my-1">
                                    ...
                                    {{--                                    <select class="form-control x-form-control" id="topup_select">--}}
                                    {{--                                        @if(count($topupbanks) > 0)--}}
                                ...
                                <div id="topup_bank" class="-deposit-form-inner-wrapper" style="display:none">
                                ...
                                {{--                                        <form target="_blank" novalidate="" id="frmluckypay" name="deposit"--}}
                                {{--                                              method="post"--}}
                                {{--                                              class="qrscan"--}}
                                {{--                                              action="{{ route('customer.topup.luckypay') }}" onsubmit="return false;">--}}
                                {{--                                            @csrf--}}
                                ...
                                {{--                                                                <div class="-turnover-wrapper">Turnover : <span>0</span>--}}
                                {{--                                                                </div>--}}
                                {{--                                                            </div>--}}
                                {{--                                                        </div>--}}
                                ...
                                {{--                                                                    placeholder="เงินฝากขั้นต่ำ 300"--}}
                                {{--                                                                    inputmode="text"--}}
                                {{--                                                                />--}}
                                {{--                                                                <button type="button"--}}
                                ...
                                {{--                                            <small>{{ __('app.topup.luckypay_detail_1') }} </small><br>--}}
                                {{--                                            <small>{{ __('app.topup.luckypay_detail_2') }} </small><br>--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                @endif--}}
                                @if($config->papayapay == 'Y')
                                    <div id="topup_papayapay" class="-deposit-form-inner-wrapper" style="display:none">
                                        ...
                                        @endauth
                                        <form target="_blank" novalidate="" id="frmpapayapay" name="deposit"
                                              method="post"
                                              class="qrscan"
                                              action="{{ route('customer.topup.papayapay') }}" onsubmit="return false;">
                                            @csrf
                                            <div class="-fake-bg-bottom-wrapper">
                                                <div class="x-modal-separator-container">
                                                    <div class="-top">
