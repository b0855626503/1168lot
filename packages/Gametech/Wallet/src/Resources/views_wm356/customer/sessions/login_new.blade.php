                                ...
                                <li class="nav-item -provider-card-item -first">
                                    <a href="javascript:void(0);">
                                        ...
                                        <img
                                                ...
                                                width="400"
                                                height="580"
                                                data-src="/assets/wm356/images/index-slot-category-first-banner.jpg?v=3"
                                ...
                                <li class="nav-item -provider-card-item -first">
                                    <a href="javascript:void(0);">
                                        ...
                                        <img
                                                ...
                                                width="400"
                                                height="580"
                                                data-src="/assets/wm356/images/index-casino-category-first-banner.jpg?v=3"
                                                src="https://asset.cloudigame.co/build/admin/img/ezl-default-loading-big.png"
                                        />
                                    </a>
                                </li>
