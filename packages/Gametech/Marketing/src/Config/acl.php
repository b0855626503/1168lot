...
return [
    ...
    [
        'key' => 'marketing.marketing_campaign.dashboard.bonus_all',
        'name' => 'เห็น ยอดรับโบนัสทั้งหมด',
        'route' => '',
        'sort' => 10,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.bonus_today',
        'name' => 'เห็น ยอดรับโบนัสวันนี้',
        'route' => '',
        'sort' => 11,
    ], 
    [
        'key' => 'marketing.marketing_campaign.dashboard.register_deposit',
        'name' => 'เห็น สมัครวันนี้ - ฝาก',
        'route' => '',
        'sort' => 12,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.register_not_deposit',
        'name' => 'เห็น สมัครวันนี้ - ไม่ฝาก',
        'route' => '',
        'sort' => 13,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.register_all_deposit',
        'name' => 'เห็น สมาชิกเก่าฝาก วันนี้',
        'route' => '',
        'sort' => 14,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.member_all_first_deposit',
        'name' => 'เห็น สมาชิกทั้งหมด ฝากแรก วันนี้',
        'route' => '',
        'sort' => 15,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.deposit_register_today',
        'name' => 'เห็น สมาชิกสมัครและฝาก วันนี้',
        'route' => '',
        'sort' => 16,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.regis',
        'name' => 'เห็น กราฟยอดสมัคร / วัน',
        'route' => '',
        'sort' => 17,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.income',
        'name' => 'เห็น กราฟยอดฝาก-ถอน / วัน',
        'route' => '',
        'sort' => 18,
    ],
    [
        'key' => 'marketing.marketing_campaign.dashboard.click',
