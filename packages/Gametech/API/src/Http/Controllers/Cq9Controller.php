    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'CQ9')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/CQ9'.now()->format('Y_m_d').'.log');
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $data_sub = GameLogProxy::where('company', 'CQ9')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'CQ9')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    if ($datasub) {
                        ...
                        $datasub_s = GameLogProxy::where('company', 'CQ9')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'refundsub')
                            ->where('con_1', $item['id'])
                        ...
                        if ($datasub_s) {
                            ...
                            $datasubs = GameLogProxy::where('company', 'CQ9')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    if ($datasub) {
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'CQ9')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'betsub')
                                ->where('con_1', $item['id'])
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'CQ9')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                    ...
                    if ($datasub2) {
                        ...
                        $balance = ($member->balance - $item['payoutAmount']);
                        ...
                        if ($balance >= 0) {
                            ...
                            GameLogProxy::where('company', 'CQ9')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('amount', $item['payoutAmount'])
