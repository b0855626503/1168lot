...
//                        ->first();
                    ...
                    if ($item['status'] == 'DEBIT') {
                        ...
                        $balance = $member->balance - $item['amount'];
                        ...
                        MemberProxy::where('user_name', $session['username'])->decrement('balance', $item['amount']);
                        $member = MemberProxy::where('user_name', $session['username'])->first();
...
//                        ->where('con_1', $item['id'])
                    ...
                    $balance = $member->balance + ($item['betAmount'] - $item['payoutAmount']);
