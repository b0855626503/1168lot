        ...
        if ($member) {
            ...
            if ($data) {
                ...
                $param = [
                    ...
                    'NewBalance' => (float)$member->balance
                ];
                ...
                if ($balance >= 0) {
                    ...
                    MemberProxy::where('user_name', $session['PlayerId'])->decrement('balance', $session['BetAmount']);
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                if ($datasub) {
                    ...
                    MemberProxy::where('user_name', $session['PlayerId'])->increment('balance', $session['Payout']);
                    $member = MemberProxy::where('user_name', $session['PlayerId'])->first();


//                $member->balance += $session['Payout'];
//                $member->save();
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                if ($datasub) {
                    ...
                    MemberProxy::where('user_name', $session['PlayerId'])->increment('balance', $session['BetAmount']);
                    $member = MemberProxy::where('user_name', $session['PlayerId'])->first();
