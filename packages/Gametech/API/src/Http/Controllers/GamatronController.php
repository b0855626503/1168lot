    ...
    public function withdrawDeposit(Request $request)
    {
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                $member->balance -= $session['withdrawAmount'];
                $member->balance += $session['depositAmount'];
                $member->save();
                ...
                if (count($datasubs) > 0) {
                    ...
                    foreach ($datasubs as $datasub) {
                        ...
                        if ($datasub['method'] == 'bet') {
                            ...
                            $member->balance += $datasub['input']['withdrawAmount'];
                            $member->balance -= $datasub['input']['depositAmount'];
                            $member->save();
