        ...
        if ($member) {
            ...
            if ($session['transaction_id'] == '') {
                ...
                if ($data) {
                    ...
                    MemberProxy::where('user_name', $session['account'])->increment('balance', $session['jp_win']);
                    $member = MemberProxy::where('user_name', $session['account'])->first();


//                    $member->balance += $session['jp_win'];
//                    $member->save();
...
//                        ->whereNull('con_2')
                    ...
                    if ($datasub) {
                        ...
                        if ($datasub['method'] == 'bet') {
                            ...
                            MemberProxy::where('user_name', $session['account'])->increment('balance', $datasub['input']['amount']);
                            $member = MemberProxy::where('user_name', $session['account'])->first();
