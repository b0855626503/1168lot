...
class KaGamingsController extends AppBaseController
{
    protected $_config;
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $data_sub = GameLogProxy::where('company', 'KAGAME')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
...
//                        ->whereNull('con_4')
                    ...
                    if ($datasub) {
                        ...
                        $datasub_s = GameLogProxy::where('company', 'KAGAME')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'refundsub')
                            ->where('con_1', $item['id'])
...
//                                    ->orderByDesc('id')
                                ...
                                if ($datasubss) {
                                    ...
                                    //                                    if($datasubss['amount'] == $item['betAmount']){
                                    ...
                                    MemberProxy::where('user_name', $session['username'])->increment('balance', $amountsub);
                                    $member = MemberProxy::where('user_name', $session['username'])->first();
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    if ($item['betAmount'] > 0) {
                        ...
                        $datasub_main = GameLogProxy::where('company', 'KAGAME')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                            ->where('con_3', $item['txnId'])
                    ...
                    if ($datasubs) {
                        ...
                        if ($datasubss) {
                            ...
                            $datasub2 = GameLogProxy::where('company', 'KAGAME')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('amount', $item['payoutAmount'])
