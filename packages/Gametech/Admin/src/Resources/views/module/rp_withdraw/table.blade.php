    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                let html = '<tr>';
                html += '<th style="text-align:right;width:80%;color:red">รวมยอดถอนแจ้งถอน (ทั้งหมด)</th><th style="text-align:right;color:red;">' + table.ajax.json().withdraw_balance_all + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:red">รวมยอดถอนรับจริง (ทั้งหมด)</th><th style="text-align:right;color:red;">' + table.ajax.json().withdraw_all + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:red">รวมยอดถอนแจ้งถอน (อนุมัติ)</th><th style="text-align:right;color:red;">' + table.ajax.json().withdraw_balance + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:red">รวมยอดถอนรับจริง (อนุมัติ)</th><th style="text-align:right;color:red;">' + table.ajax.json().withdraw_yes + '</th>';
                html += '</tr>';
                html += '<tr>';
