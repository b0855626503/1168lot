...
use Gametech\Admin\DataTables\BankinOldDataTable;
use Gametech\Member\Repositories\MemberRepository;
use Gametech\Payment\Repositories\BankPaymentRepository;
use Illuminate\Http\Request;


class BankinOldController extends AppBaseController
{
    protected $_config;
    ...
    public function index(BankinOldDataTable $bankinOldDataTable)
    {
        return $bankinOldDataTable->render($this->_config['view']);
    }
