...
class FreeGameController extends AppBaseController
{
    ...
    public function loadProduct()
    {
        ...
        $responses = collect(app('Gametech\Game\Repositories\GameSeamlessRepository')->findWhere(['enable' => 'Y','status_open' => 'Y' , 'method' => 'seamless'])->toArray());
    ...
    public function loadGame(Request $request)
    {
        ...
        $responses = collect(GameListProxy::where('product',$product)->get()->toArray());
