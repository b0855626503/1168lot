...
class GameSingleTransformer extends TransformerAbstract
{


    public function transform(GameSingle $model)
    {
...
//            'icon' => '<img src="' . Storage::url('icon_img/' . $model->icon) . '" class="rounded" style="width:50px;height:50px;">',
            'action' => view('admin::module.game_single.datatables_actions', ['code' => $model->code])->render(),
        ];
    }
