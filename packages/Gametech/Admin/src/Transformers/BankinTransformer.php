...
class BankinTransformer extends TransformerAbstract
{
    ...
    protected function buildConfirmHtml(int $code, int $status, string $txid, string $autocheck, int $member_topup): string
    {
    ...
    public function transform(BankPayment $model): array
    {
        ...
        $member_topup = (int) ($model->member_topup ?? 0);
        ...
        return [
            ...
            'confirm'    => $this->buildConfirmHtml($code, $status, $txid, $autocheck, $member_topup),
