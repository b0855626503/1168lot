...
//            ['data' => 'sort' , 'name' => 'banks_account.sort' , 'title' => 'ลำดับ' , 'orderable' => false , 'searchable' => false, 'className' => 'text-center text-nowrap' ],
            ...
            ['data' => 'lineconnect', 'name' => 'banks_account.slip', 'title' => 'connect', 'orderable' => false, 'searchable' => false, 'className' => 'text-center text-nowrap', 'width' => '3%'],
            ['data' => 'choose', 'name' => 'banks_account.slip', 'title' => 'ดึงจาก', 'orderable' => false, 'searchable' => false, 'className' => 'text-center text-nowrap', 'width' => '3%'],
            ['data' => 'payment', 'name' => 'banks_account.payment', 'title' => 'Payment', 'orderable' => false, 'searchable' => false, 'className' => 'text-center text-nowrap', 'width' => '3%'],
