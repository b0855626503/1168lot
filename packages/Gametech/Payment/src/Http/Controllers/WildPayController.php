...
//        if($check && $check->status === 'EXPIRED'){
//
//
//            Log::channel('wildpay_cancel_create')->info('สถานะรายการ Expired', [
//                'debug' => $check,
//            ]);
//
//
...
//            $response = $api->create_cancel($cancelUrl, $params);
//
//            Log::channel('wildpay_cancel_create')->info('สถานะรายการ API Cancel', [
//                'debug' => $response,
//            ]);
//
//            if ($response['success'] === true) {
...
//
//                    Log::channel('wildpay_cancel_create')->info('สถานะรายการ API Cancel Code != 9995', ['code' => $response['code']]);
//
//                    return response()->json([
//                        'success' => false,
//                        'msg' => __('app.topup.cancel_failed'),
