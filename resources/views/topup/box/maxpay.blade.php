                    ...
                    <div class="qr-grid">
                        ...
                        <article class="card" role="region" aria-label="Thai QR Payment">
                            ...
                            <div class="body">
                                ...
                                {{--                    </div>--}}
                                <div class="warn">ห้ามใช้ บช ที่มี คำนำหน้าว่า ดช และ ดญ และ พระ และ ตำรวจ ในการทำรายการนี้ </div>
                                ...
                                <div class="body">
                                    <div class="meta">
                                        <div class="info"
                                            ...
                                            <br><strong>ห้ามสแกนจ่าย เด็ดขาด!! ถ้า บช คุณมีคำนำหน้า ว่า ดช และ ดญ หรือ พระ และ ตำรวจ</strong>
                                        </div>
                                    </div>
                                </div>
                            </article>
...
@push('scripts')
    ...
    <script>
        ...
        function expireAction() {
            fetch("{{ route('api.maxpay.deposit.expire', ['txid' => $data['detail']]) }}", {
                method: 'POST',
                headers: {
    ...
    <script>
        ...
        const interval = setInterval(async () => {
            try {
                const res = await fetch("{{ route('api.maxpay.deposit.status', ['txid' => $data['detail']]) }}");
