...
<div class="container">
	...
	<div class="qr-box">
		...
		@elseif ($type === 'promptpay_emv')
			<img id="qrcode"
			     src="data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(200)->generate($data['qrcode'])) }}"
			     alt="QR Code">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (svg) {
            ...
            // กำหนดให้ปุ่มดาวน์โหลดทำงาน
            const downloadBtn = document.getElementById('download-btn');
            downloadBtn.href = url;
            downloadBtn.download = 'qrcode_' + Date.now() + '.svg';
        }
    });
