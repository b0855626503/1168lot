...
class LottoWinningReportCommandsTest extends TestCase
{
    ...
    public function test_backfill_rerun_no_duplicate_and_reconcile_success(): void
    {
        $exit1 = Artisan::call('lotto:winning-report:backfill', [
            '--round_id' => 301,
        ]);
    ...
    private function prepareSchema(): void
    {
        ...
        Schema::create('lotto_draws', function (Blueprint $table): void {
            ...
            $table->enum('status', ['draft', 'open', 'closed', 'resulted'])->default('resulted');
    ...
    private function seedData(): void
    {
        ...
        \DB::table('lotto_ticket_items')->insert([
            ...
            'amount' => 100,
            'payout_at_time' => 10,
            'potential_win_amount_at_time' => null,
            'result_status' => null,
            'win_amount' => 0,
            'created_at' => now(),
            'updated_at' => now(),
